...
def main(auto_upgrade_energy, auto_upgrade_multitap, auto_upgrade_passive, lanjut_upgrade, cek_task_list, ask_cipher, cipher_text):
            ...
            if response.status_code == 200:
                ...
                if response.status_code == 200:
                    ...
                    if daily_response['isCompleted']:
                        ...
                        print(Fore.RED + Style.BRIGHT + f"\r[ Checkin Daily ] Days {daily_response['days']} | Belum saatnya claim daily", flush=True)
                else:
...
# Jika dijalankan sebagai skrip mandiri, gunakan input interaktif
if __name__ == "__main__":
    ...
    main(auto_upgrade_energy, auto_upgrade_multitap, auto_upgrade_passive, lanjut_upgrade, cek_task_list, ask_cipher, cipher_text)